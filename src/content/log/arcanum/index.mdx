...
description: 'An exploration of building a desktop RSS reader using Tauri and Rust, highlighting the advantages of Tauri over Electron and the libraries used in the project.'
date: 2023-02-27
tags: ['rss', 'tauri', 'rust']
image: './banner.png'
authors: ['dhonus']
