---
title: 'Useful NetBSD commands to get working installation with DWM'
description: 'A collection of commands and tips to help set up a working NetBSD installation with DWM, including fixing SSL errors, setting up package mirrors, and compiling DWM.'
date: 2022-12-16
tags: ['netbsd', 'dwm', 'installation']
authors: ['dhonus']
---
